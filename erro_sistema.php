...
echo "<h2>Algo deu errado, contate o administrador.</h2>";
echo "<p>Pode ser que você não tenha acesso a este conteúdo</p>";
echo "<a href='index.php' class='link'>Voltar</a>";
echo "</div>";
echo "</center>";
