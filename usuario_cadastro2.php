...
$query = "INSERT INTO usuarios(ativo_user,nivel_user,nome_user,email_user,telefone_user,senha_user,termos_user)
VALUES ('$ativo','$nivel','$nome','$email','$telefone','$senha','$termos')";
