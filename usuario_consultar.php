...
echo "<br><a href='usuarios.php' class='link'><img src='./imagens/voltar.png'><small>Voltar</small></a>";
...
echo "<tr><td>Nivel</td><td>".$row['nivel_user']."</td><tr>";
echo "<tr><td>Nome</td><td>".$row['nome_user']."</td><tr>";
echo "<tr><td>E-mail</td><td>".$row['email_user']."</td><tr>";
echo "<tr><td>Telefone</td><td>".$row['telefone_user']."</td><tr>";
echo "</table>";
